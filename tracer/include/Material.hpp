...
namespace materials
{
  ...
  const Material thin_glass(
    math::Vec3f(0.6f, 0.7f, 0.8f), math::Vec4f(0.0f, 0.5f, 0.1f, 0.8f), 125.0f, 1.01f);
  const Material glass(
    math::Vec3f(0.6f, 0.7f, 0.8f), math::Vec4f(0.0f, 0.5f, 0.1f, 0.8f), 125.0f, 1.5f);
  const Material red_rubber(
    math::Vec3f(0.3f, 0.1f, 0.1f), math::Vec4f(0.9f, 0.1f, 0.0f, 0.0f), 5.0f, 1.0f);
